    ...
    public class NVRHand : MonoBehaviour
    {
        ...
        private bool PickupClosest()
        {
			...
			if (hits.Length > 0) {
				...
				//NVRInteractable alex = grabbedObject.AddComponent<NVRInteractable> () as NVRInteractable;
				//grabbedObject.GetComponent<Rigidbody> ().isKinematic = true;

				NVRInteractable alex = grabbedObject.GetComponent<NVRInteractable>();
				BeginInteraction(alex);
				return true;
